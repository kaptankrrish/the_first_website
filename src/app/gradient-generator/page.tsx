      ...
      <div className="relative overflow-hidden mb-6">
        ...
        <div className="relative flex items-start gap-3 sm:gap-4 min-w-0">
          <motion.div
            ...
            className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-br from-pink-500/20 via-rose-500/20 to-fuchsia-500/20 border border-white/10 flex items-center justify-center shrink-0 shadow-[0_0_24px_rgba(244,114,182,0.2)]"
          >
            <Palette className="w-5 h-5 sm:w-6 sm:h-6 text-pink-200" />
          </motion.div>
          <div className="min-w-0">
            <div className="flex flex-wrap items-center gap-2 mb-1.5">
              <span className="px-2 py-0.5 rounded-full bg-pink-500/15 text-pink-300 text-[10px] font-semibold uppercase tracking-[0.18em] border border-pink-400/20 inline-flex items-center gap-1.5">
                <span className="relative flex h-1.5 w-1.5">
                  <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-pink-400 opacity-75" />
                  <span className="relative inline-flex h-1.5 w-1.5 rounded-full bg-pink-400 shadow-[0_0_6px_rgba(244,114,182,0.8)]" />
                </span>
                CSS Studio
              </span>
