    ...
    <div className="space-y-8">
      <div className="space-y-2">
        <h1 className="text-4xl font-bold tracking-tight text-white flex items-center gap-3">
          <QuoteIcon className="h-8 w-8 text-amber-400" />
          {t.quotes.title}
      ...
      {dailyQuote && (
        ...
        >
          <Card className="relative overflow-hidden border-amber-500/20 bg-gradient-to-br from-amber-500/10 via-yellow-500/5 to-orange-500/10 backdrop-blur-xl">
